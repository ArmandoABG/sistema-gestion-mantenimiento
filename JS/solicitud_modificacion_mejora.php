...
$cssSolicitud = __DIR__ . '/../css/style_solicitud_modificacion_mejora.css';
...
<head>
    ...
    <meta
        name="description"
        content="Registro profesional de solicitudes de modificación o mejora"
    >

    <title>Modificación o mejora | Sistema de Mantenimiento</title>

    <link
        rel="stylesheet"
        href="../css/style_solicitud_modificacion_mejora.css?v=<?= htmlspecialchars($versionCss, ENT_QUOTES, 'UTF-8') ?>"
    >
</head>
<body>
...
<svg class="scp-svg-sprite" aria-hidden="true" focusable="false">
    ...
    <symbol id="scp-icon-bulb" viewBox="0 0 24 24">
        <path d="M9 18h6M10 22h4"/>
        <path d="M8.2 14.5A7 7 0 1 1 15.8 14.5C14.7 15.4 14 16.5 14 18h-4c0-1.5-.7-2.6-1.8-3.5Z"/>
    </symbol>
    <symbol id="scp-icon-target" viewBox="0 0 24 24">
...
<main class="contenido-principal scp-page">
    ...
    <section class="scp-encabezado" aria-labelledby="tituloModificacionMejora">
        ...
        <div class="scp-encabezado__contenido">
            <div class="scp-encabezado__copy">
                ...
                <h1 id="tituloModificacionMejora">Modificación o mejora</h1>

                <p>
                    <?= $esAdministrador
                        ? 'Registra una propuesta directa o a nombre de un solicitante activo. Después podrá revisarse, corregirse y programarse.'
                        : 'Propón una modificación o mejora para un equipo. Explica qué cambio necesitas; los datos técnicos que desconozcas pueden quedar en blanco.'
                    ?>
                </p>
            ...
            <div class="scp-encabezado__acciones">
                <div class="scp-hero-mini-card" aria-hidden="true">
                    <span class="scp-hero-mini-card__icono">
                        <svg><use href="#scp-icon-bulb"></use></svg>
                    </span>
                    <div>
    ...
    <section class="scp-resumen" aria-label="Resumen de solicitudes de modificación o mejora">
        <article class="scp-resumen__card scp-resumen__card--total">
            <span class="scp-resumen__icono" aria-hidden="true">
                <svg><use href="#scp-icon-bulb"></use></svg>
            </span>
            <div>
                <span>Mejoras registradas</span>
        ...
        <article class="scp-panel scp-panel--formulario">
            <header class="scp-panel__encabezado">
                <div>
                    ...
                    <h2>Información de la mejora</h2>
                    <p>Los campos marcados con * son obligatorios. <?= $esAdministrador ? 'La propuesta quedará registrada con el administrador como capturista.' : 'El administrador podrá completar o corregir la información técnica.' ?></p>
                </div>
            ...
            <form id="formSolicitud" novalidate>
                ...
                <section class="scp-seccion" aria-labelledby="tituloSolicitud">
                    <div class="scp-seccion__titulo">
                        ...
                        <div>
                            <h3 id="tituloSolicitud">Describe la modificación o mejora</h3>
                            <p>Explica el cambio que necesitas con palabras sencillas. No es obligatorio conocer la causa técnica, el costo ni la solución definitiva.</p>
                        </div>
                    </div>
                    ...
                    <div class="scp-grid">
                        <label class="scp-campo">
                            ...
                            <small class="scp-ayuda">La prioridad urgente se registra en el módulo Correctivo urgente.</small>
                        ...
                        <label class="scp-campo scp-campo--completo">
                            <span>¿Qué modificación o mejora necesitas? *</span>
                            <textarea
                                ...
                                minlength="20"
                                maxlength="2500"
                                placeholder="Ejemplo: Instalar una guarda desmontable en la transmisión para facilitar la limpieza y evitar el contacto con las partes móviles."
                                required
                            ></textarea>
                            <div class="scp-campo__pie">
                                <small>Indica qué deseas cambiar, en qué parte del equipo y por qué sería útil.</small>
                ...
                <details class="scp-opcionales scp-opcionales--mejora" id="detallesOpcionales">
                    <summary>
                        <span>Información complementaria</span>
                        <small>Opcional: llénala únicamente cuando la conozcas</small>
                    </summary>

                    <div class="scp-opcionales__contenido">
                        <div class="scp-bloque-opcional scp-bloque-opcional--categorias">
                            <div class="scp-bloque-opcional__titulo">
                                <strong>¿Qué aspecto busca mejorar?</strong>
                                <small>Puedes elegir ninguno, uno o varios.</small>
                            </div>

                            <div
                                class="scp-causas-grid"
                                id="causasMejoraContenedor"
                                aria-live="polite"
                            >
                                <div class="scp-catalogo-cargando">Cargando opciones...</div>
                            </div>
                            <small class="scp-error-campo" data-error-for="causas_mejora"></small>
                        </div>

                        <div class="scp-grid">
                            <label class="scp-campo scp-campo--completo">
                                <span>Objetivo de la mejora <em>opcional</em></span>
                                <textarea
                                    id="objetivo_mejora"
                                    name="objetivo_mejora"
                                    rows="3"
                                    maxlength="1500"
                                    placeholder="Ejemplo: reducir el riesgo de accidente y facilitar la limpieza diaria."
                                ></textarea>
                                <small class="scp-error-campo" data-error-for="objetivo_mejora"></small>
                            </label>

                            <label class="scp-campo scp-campo--completo">
                                <span>Resultado esperado <em>opcional</em></span>
                                <textarea
                                    id="resultado_esperado"
                                    name="resultado_esperado"
                                    rows="3"
                                    maxlength="1500"
                                    placeholder="Ejemplo: una protección segura, fácil de retirar y que no dificulte la operación."
                                ></textarea>
                                <small class="scp-error-campo" data-error-for="resultado_esperado"></small>
                            </label>

                            <label class="scp-campo scp-campo--completo">
                                <span>Justificación <em>opcional</em></span>
                                <textarea
                                    id="justificacion_mejora"
                                    name="justificacion_mejora"
                                    rows="3"
                                    maxlength="1800"
                                    placeholder="Explica por qué consideras conveniente realizar el cambio."
                                ></textarea>
                                <small class="scp-error-campo" data-error-for="justificacion_mejora"></small>
                            </label>

                            <label class="scp-campo scp-campo--completo">
                                <span>Costo contra beneficio <em>opcional</em></span>
                                <textarea
                                    id="costo_vs_beneficio"
                                    name="costo_vs_beneficio"
                                    rows="3"
                                    maxlength="1800"
                                    placeholder="Llénalo solo si conoces una inversión aproximada, ahorro, reducción de riesgo o beneficio esperado."
                                ></textarea>
                                <small class="scp-error-campo" data-error-for="costo_vs_beneficio"></small>
                            </label>

                            <label class="scp-campo scp-campo--completo">
                                <span>Impacto actual en la operación <em>opcional</em></span>
                                <textarea
                                    id="impacto_operacion"
                                    name="impacto_operacion"
                                    rows="3"
                                    maxlength="1500"
                                    placeholder="Ejemplo: retrasa la limpieza, reduce la productividad o dificulta una tarea."
                                ></textarea>
                            ...
                            <label class="scp-campo scp-campo--completo">
                                ...
                                <textarea
                                    ...
                                    rows="3"
                                    maxlength="1500"
                                    placeholder="Agrega medidas, ubicación exacta, antecedentes u otra información útil."
                                ></textarea>
                ...
                <section class="scp-seccion scp-seccion--seguridad" aria-labelledby="tituloSeguridadMejora">
                    <div class="scp-seccion__titulo">
                        <span aria-hidden="true">4</span>
                        <div>
                            <h3 id="tituloSeguridadMejora">Datos de seguridad</h3>
                            <p>Indica si realizar la modificación podría implicar algún peligro.</p>
                        </div>
                    </div>
                    ...
                    <div class="scp-checks">
                        <label class="scp-check">
                            ...
                            <span><strong>Requiere detener el equipo</strong><small>Márcalo cuando no sea seguro trabajar con el equipo operando.</small></span>
                        </label>
                        <label class="scp-check">
                            <input type="checkbox" id="trabajo_peligroso" name="trabajo_peligroso" value="1">
                            <span><strong>Trabajo peligroso</strong><small>Altura, carga pesada, electricidad, temperatura, presión u otro riesgo.</small></span>
                        </label>
                    </div>

                    <div class="scp-grid scp-seguridad-detalle" id="detalleSeguridadMejora" hidden>
                        <label class="scp-campo">
                        ...
                        <label class="scp-campo scp-campo--completo">
                            ...
                            <textarea id="detalle_trabajo_peligroso" name="detalle_trabajo_peligroso" rows="2" minlength="3" maxlength="200" placeholder="Ej. Trabajo en altura y movimiento de una pieza pesada."></textarea>
                ...
                <div class="scp-form-acciones">
                    <p>
                        Al enviar, la propuesta quedará <strong>PENDIENTE</strong> para que el administrador revise y complete la información necesaria.
                    </p>
        ...
        <aside class="scp-columna-lateral">
            ...
            <section class="scp-panel scp-panel--guia">
                ...
                <div class="scp-checklist">
                    ...
                    <div data-check="equipo">
                        ...
                        <p>Equipo identificado por código o nombre</p>
                    </div>
                    <div data-check="descripcion">
                        <span><?= $esAdministrador ? '3' : '2' ?></span>
                        <p>Mejora explicada claramente</p>
                    </div>
            ...
            <section class="scp-panel scp-panel--recientes">
                ...
                <div class="scp-vacio" id="vacioRecientes" hidden>
                    <?= $esAdministrador ? 'Todavía no has registrado solicitudes de mejora.' : 'Todavía no tienes solicitudes de mejora.' ?>
                </div>
    ...
    <footer class="scp-footer">
        ...
        <span>Registro de modificaciones y mejoras · Los Chapeteados División Petfood</span>
    </footer>
...
(function () {
    ...
    var ENDPOINT = '../funciones/solicitud_modificacion_mejora_funciones.php';
    var estado = {
        cargado: false,
    ...
    function capturarElementos() {
        ...
        elementos.causasMejoraContenedor = document.getElementById('causasMejoraContenedor');
        elementos.trabajoPeligroso = document.getElementById('trabajo_peligroso');
        elementos.requiereParoEquipo = document.getElementById('requiere_paro_equipo');
        elementos.detalleSeguridadMejora = document.getElementById('detalleSeguridadMejora');
    ...
    function registrarEventos() {
        ...
        elementos.trabajoPeligroso.addEventListener('change', function () {
            ...
            elementos.detalleSeguridadMejora.hidden = !activo;
    ...
    async function enviarFormulario(evento) {
        ...
        var confirmar = await SistemaUI.confirmar({
            titulo: '¿Registrar modificación o mejora?',
        ...
        try {
            ...
            datos.set('requiere_paro_equipo', elementos.requiereParoEquipo.checked ? '1' : '0');
            datos.set('nivel_riesgo', elementos.trabajoPeligroso.checked ? elementos.nivelRiesgo.value : 'BAJO');
            datos.set('detalle_trabajo_peligroso', elementos.trabajoPeligroso.checked ? elementos.detalleTrabajoPeligroso.value.trim() : '');
                ...
                html:
                    '<p class="scp-swal-texto">' +
                        escapar(estado.rol === 'ADMIN'
                            ...
                            : 'Tu propuesta quedó pendiente de revisión.') +
                    '</p>' +
    ...
    function validarFormulario() {
        ...
        if (descripcion.length < 20) {
            return {
                ...
                mensaje: 'Describe la modificación o mejora usando al menos 20 caracteres.'
            };
        }
    ...
    async function confirmarLimpiar() {
        var camposOpcionales = elementos.form.querySelectorAll(
            '#detallesOpcionales textarea, #detallesOpcionales input[type="checkbox"]'
        );
        var tieneDatosOpcionales = Array.prototype.some.call(
            camposOpcionales,
            function (campo) {
    ...
    function limpiarFormulario(enfocarCodigo) {
        ...
        elementos.formToken.value = estado.formToken;
        elementos.detalleSeguridadMejora.hidden = true;
    ...
    function pintarCatalogos(catalogos) {
        estado.causasMejora = Array.isArray(catalogos.causas_mejora)
            ? catalogos.causas_mejora
            : [];
    ...
    function pintarCausasMejora() {
        elementos.causasMejoraContenedor.innerHTML = '';

        if (estado.causasMejora.length === 0) {
            elementos.causasMejoraContenedor.innerHTML =
                '<div class="scp-catalogo-vacio">No hay categorías de mejora activas. Puedes enviar la solicitud sin seleccionarlas.</div>';
            return;
        }

        estado.causasMejora.forEach(function (item) {
            var etiqueta = document.createElement('label');
            etiqueta.className = 'scp-causa-card';

            var input = document.createElement('input');
            input.type = 'checkbox';
            input.name = 'causas_mejora[]';
            input.value = String(item.id || '');

            var contenido = document.createElement('span');
            contenido.innerHTML =
                '<strong>' + escapar(item.nombre || 'Sin nombre') + '</strong>' +
                '<small>Seleccionar</small>';

            etiqueta.appendChild(input);
            etiqueta.appendChild(contenido);
            elementos.causasMejoraContenedor.appendChild(etiqueta);
        });
    }
    ...
    function pintarRecientes(lista) {
        ...
        lista.forEach(function (solicitud) {
            ...
            articulo.innerHTML =
                ...
                (solicitud.causas_mejora
                    ? '<small class="scp-reciente__causas">Enfoque: ' + escapar(solicitud.causas_mejora) + '</small>'
                    : '') +
    ...
    function mostrarEstadoRecientes(tipo) {
        ...
        if (tipo === 'error') {
            ...
            elementos.vacioRecientes.textContent = estado.rol === 'ADMIN'
                ? 'Todavía no has registrado solicitudes de mejora.'
                : 'Todavía no tienes solicitudes de mejora.';
        }
    }
